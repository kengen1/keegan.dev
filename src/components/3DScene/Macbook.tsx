...
export default function Macbook(props: JSX.IntrinsicElements['group']) {
  ...
  useEffect(() => {
    ...
    const updateScale = () => {
      cancelAnimationFrame(resizeTimeout) // Cancel any pending resize calculations
    ...
    updateScale() // Run once initially
          ...
          <mesh geometry={nodes['Cube008_2'].geometry}>
            <Html className="content" rotation-x={-Math.PI / 2} position={[0, 0.05, -0.09]} transform occlude>
              <div className={styles.screenContainer}>
                <div className={styles.innerContent}>Hi there! I'm Keegan</div>
              </div>
            </Html>
          </mesh>
        </group>
